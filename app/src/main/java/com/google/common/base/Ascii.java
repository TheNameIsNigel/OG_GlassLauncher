...
public final class Ascii {
    ...
    public static String truncate(CharSequence seq, int maxLength, String truncationIndicator) {
        ...
        Preconditions.checkArgument(z, "maxLength (%s) must be >= length of the truncation indicator (%s)", Integer.valueOf(maxLength), Integer.valueOf(truncationIndicator.length()));
