...
public enum CaseFormat {
    ...
    private static final class StringConverter extends Converter<String, String> implements Serializable {
        ...
        public boolean equals(@Nullable Object object) {
            ...
            if (this.sourceFormat.equals(that.sourceFormat)) {
                return this.targetFormat.equals(that.targetFormat);
            }
            return false;
        }
    ...
    public static String firstCharOnlyToUpper(String word) {
        ...
        return new StringBuilder(word.length()).append(Ascii.toUpperCase(word.charAt(0))).append(Ascii.toLowerCase(word.substring(1))).toString();
    }
}
