...
abstract class Cut<C extends Comparable> implements Comparable<Cut<C>>, Serializable {
    ...
    private static final class BelowValue<C extends Comparable> extends Cut<C> {
        ...
        private static final /* synthetic */ int[] f25comgooglecommoncollectBoundTypeSwitchesValues = null;
        private static final long serialVersionUID = 0;

        /* renamed from: -getcom-google-common-collect-BoundTypeSwitchesValues  reason: not valid java name */
        private static /* synthetic */ int[] m257getcomgooglecommoncollectBoundTypeSwitchesValues() {
            if (f25comgooglecommoncollectBoundTypeSwitchesValues != null) {
                return f25comgooglecommoncollectBoundTypeSwitchesValues;
            }
            ...
            f25comgooglecommoncollectBoundTypeSwitchesValues = iArr;
            return iArr;
        }
        ...
        public Cut<C> withLowerBoundType(BoundType boundType, DiscreteDomain<C> domain) {
            switch (m257getcomgooglecommoncollectBoundTypeSwitchesValues()[boundType.ordinal()]) {
                case 1:
                    return this;
                case 2:
    ...
    private static final class AboveValue<C extends Comparable> extends Cut<C> {
        ...
        /* renamed from: -com-google-common-collect-BoundTypeSwitchesValues  reason: not valid java name */
        private static final /* synthetic */ int[] f24comgooglecommoncollectBoundTypeSwitchesValues = null;
        private static final long serialVersionUID = 0;

        /* renamed from: -getcom-google-common-collect-BoundTypeSwitchesValues  reason: not valid java name */
        private static /* synthetic */ int[] m255getcomgooglecommoncollectBoundTypeSwitchesValues() {
            if (f24comgooglecommoncollectBoundTypeSwitchesValues != null) {
                return f24comgooglecommoncollectBoundTypeSwitchesValues;
            }
            int[] iArr = new int[BoundType.values().length];
            try {
                iArr[BoundType.CLOSED.ordinal()] = 1;
            ...
            f24comgooglecommoncollectBoundTypeSwitchesValues = iArr;
            return iArr;
        }
        ...
        /* access modifiers changed from: package-private */
        public Cut<C> withLowerBoundType(BoundType boundType, DiscreteDomain<C> domain) {
            switch (m255getcomgooglecommoncollectBoundTypeSwitchesValues()[boundType.ordinal()]) {
                case 1:
