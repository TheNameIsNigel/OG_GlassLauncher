...
public final class Iterables {
    ...
    public static <T> Iterable<T> unmodifiableIterable(Iterable<T> iterable) {
        ...
        return new UnmodifiableIterable(iterable, (UnmodifiableIterable) null);
    }
    ...
    private static final class UnmodifiableIterable<T> extends FluentIterable<T> {
        ...
        /* synthetic */ UnmodifiableIterable(Iterable iterable2, UnmodifiableIterable unmodifiableIterable) {
            this(iterable2);
        }
    ...
    public static <T> Iterable<T> consumingIterable(final Iterable<T> iterable) {
        if (iterable instanceof Queue) {
            return new FluentIterable<T>() {
                public Iterator<T> iterator() {
                    return new ConsumingQueueIterator((Queue) iterable, (ConsumingQueueIterator) null);
                }
    ...
    private static class ConsumingQueueIterator<T> extends AbstractIterator<T> {
        ...
        /* synthetic */ ConsumingQueueIterator(Queue queue2, ConsumingQueueIterator consumingQueueIterator) {
            this(queue2);
        }
