...
public final class ImmutableClassToInstanceMap<B> extends ForwardingMap<Class<? extends B>, B> implements ClassToInstanceMap<B>, Serializable {
    ...
    /* synthetic */ ImmutableClassToInstanceMap(ImmutableMap delegate2, ImmutableClassToInstanceMap immutableClassToInstanceMap) {
        this(delegate2);
    }
    ...
    public static final class Builder<B> {
        ...
        public ImmutableClassToInstanceMap<B> build() {
            return new ImmutableClassToInstanceMap<>(this.mapBuilder.build(), (ImmutableClassToInstanceMap) null);
        }
    }
