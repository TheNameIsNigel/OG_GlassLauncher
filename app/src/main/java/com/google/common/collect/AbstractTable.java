...
abstract class AbstractTable<R, C, V> implements Table<R, C, V> {
    ...
    public boolean contains(@Nullable Object rowKey, @Nullable Object columnKey) {
        ...
        if (row != null) {
            return Maps.safeContainsKey(row, columnKey);
        }
        return false;
    }
    ...
    class CellSet extends AbstractSet<Table.Cell<R, C, V>> {
        ...
        public boolean contains(Object o) {
            ...
            if (row != null) {
                return Collections2.safeContains(row.entrySet(), Maps.immutableEntry(cell.getColumnKey(), cell.getValue()));
            }
            return false;
        }
        ...
        public boolean remove(@Nullable Object o) {
            ...
            Map<C, V> row = (Map) Maps.safeGet(AbstractTable.this.rowMap(), cell.getRowKey());
            if (row != null) {
                return Collections2.safeRemove(row.entrySet(), Maps.immutableEntry(cell.getColumnKey(), cell.getValue()));
            }
            return false;
        }
