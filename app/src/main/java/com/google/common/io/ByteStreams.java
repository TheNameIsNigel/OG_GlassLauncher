...
public final class ByteStreams {
    ...
    static byte[] toByteArray(InputStream in, int expectedSize) throws IOException {
        ...
        FastByteArrayOutputStream out = new FastByteArrayOutputStream((FastByteArrayOutputStream) null);
        out.write(b);
        copy(in, (OutputStream) out);
    ...
    private static final class FastByteArrayOutputStream extends ByteArrayOutputStream {
        /* synthetic */ FastByteArrayOutputStream(FastByteArrayOutputStream fastByteArrayOutputStream) {
            this();
        }
