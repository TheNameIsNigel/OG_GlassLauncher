...
public class SlidingPaneLayout extends ViewGroup {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            if (child.getVisibility() == 8) {
                ...
                if (lp.height == -2) {
                    ...
                    childHeightSpec3 = View.MeasureSpec.makeMeasureSpec(maxLayoutHeight, Ints.MAX_POWER_OF_TWO);
                } else {
                        ...
                        if (!canSlide || child2 == this.mSlideableView) {
                            if (lp2.weight > 0.0f) {
                                if (lp2.width != 0) {
                                    ...
                                    childHeightSpec = View.MeasureSpec.makeMeasureSpec(maxLayoutHeight, Ints.MAX_POWER_OF_TWO);
                                } else {
                                ...
                                if (canSlide) {
                                    ...
                                    int childWidthSpec2 = View.MeasureSpec.makeMeasureSpec(newWidth, Ints.MAX_POWER_OF_TWO);
                                    if (measuredWidth != newWidth) {
                                        child2.measure(childWidthSpec2, childHeightSpec);
                                    }
                                } else {
                                    child2.measure(View.MeasureSpec.makeMeasureSpec(measuredWidth + ((int) ((lp2.weight * ((float) Math.max(0, widthRemaining))) / weightSum)), Ints.MAX_POWER_OF_TWO), childHeightSpec);
                                }
                            }
                            ...
                            if (!skippedFirstPass) {
                                ...
                                childHeightSpec2 = View.MeasureSpec.makeMeasureSpec(maxLayoutHeight, Ints.MAX_POWER_OF_TWO);
                            } else {
                                childHeightSpec2 = View.MeasureSpec.makeMeasureSpec(lp2.height, Ints.MAX_POWER_OF_TWO);
                            }
                            child2.measure(View.MeasureSpec.makeMeasureSpec(fixedPanelWidthLimit, Ints.MAX_POWER_OF_TWO), childHeightSpec2);
                        }
                    }
                }
            }
    ...
    static class SavedState extends AbsSavedState {
        ...
        SavedState(Parcel in, ClassLoader loader) {
            super(in, loader);
            boolean z = false;
            this.isOpen = in.readInt() != 0 ? true : z;
        }
