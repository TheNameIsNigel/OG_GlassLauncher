        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                case 1:
                    ...
                    if (data.readInt() != 0) {
                        resultReceiverWrapper = MediaSessionCompat.ResultReceiverWrapper.CREATOR.createFromParcel(data);
                    } else {
                        resultReceiverWrapper = null;
                    }
                    sendCommand(_arg0, bundle9, resultReceiverWrapper);
                ...
                case 14:
                    ...
                    playFromMediaId(_arg02, bundle5);
                    reply.writeNoException();
                    return true;
                case 15:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 25:
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                        ratingCompat2 = RatingCompat.CREATOR.createFromParcel(data);
                    } else {
                        ratingCompat2 = null;
                    }
                    rate(ratingCompat2);
                ...
                case 26:
                    ...
                    sendCustomAction(_arg04, bundle);
                    reply.writeNoException();
                    return true;
                case 27:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 34:
                    ...
                    prepareFromMediaId(_arg05, bundle8);
                    reply.writeNoException();
                    return true;
                case 35:
                    data.enforceInterface(DESCRIPTOR);
                    ...
                    prepareFromSearch(_arg06, bundle7);
                    reply.writeNoException();
                    return true;
                case 36:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 41:
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                        mediaDescriptionCompat3 = MediaDescriptionCompat.CREATOR.createFromParcel(data);
                    } else {
                ...
                case 42:
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                        mediaDescriptionCompat2 = MediaDescriptionCompat.CREATOR.createFromParcel(data);
                    } else {
                        mediaDescriptionCompat2 = null;
                    }
                    addQueueItemAt(mediaDescriptionCompat2, data.readInt());
                    reply.writeNoException();
                    return true;
                case 43:
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                        mediaDescriptionCompat = MediaDescriptionCompat.CREATOR.createFromParcel(data);
                    } else {
                ...
                case 51:
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                        ratingCompat = RatingCompat.CREATOR.createFromParcel(data);
                    } else {
                        ratingCompat = null;
                    }
                    if (data.readInt() != 0) {
        ...
        private static class Proxy implements IMediaSession {
            ...
            public ParcelableVolumeInfo getVolumeAttributes() throws RemoteException {
                ...
                try {
                    ...
                    _reply.readException();
                    if (_reply.readInt() != 0) {
                        parcelableVolumeInfo = ParcelableVolumeInfo.CREATOR.createFromParcel(_reply);
                    } else {
            ...
            public MediaMetadataCompat getMetadata() throws RemoteException {
                ...
                try {
                    ...
                    _reply.readException();
                    if (_reply.readInt() != 0) {
                        mediaMetadataCompat = MediaMetadataCompat.CREATOR.createFromParcel(_reply);
                    } else {
            ...
            public PlaybackStateCompat getPlaybackState() throws RemoteException {
                ...
                try {
                    ...
                    _reply.readException();
                    if (_reply.readInt() != 0) {
                        playbackStateCompat = PlaybackStateCompat.CREATOR.createFromParcel(_reply);
                    } else {
