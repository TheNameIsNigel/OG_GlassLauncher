...
public class AudioAttributesCompat {
    ...
    /* synthetic */ AudioAttributesCompat(AudioAttributesCompat audioAttributesCompat) {
        this();
    }
    ...
    public static class Builder {
        ...
        public AudioAttributesCompat build() {
            if (AudioAttributesCompat.sForceLegacyBehavior || Build.VERSION.SDK_INT < 21) {
                AudioAttributesCompat aac = new AudioAttributesCompat((AudioAttributesCompat) null);
    ...
    public boolean equals(Object o) {
        ...
        if (this.mLegacyStream != null) {
            return this.mLegacyStream.equals(that.mLegacyStream);
        }
        if (that.mLegacyStream != null) {
            return false;
        }
        return true;
    }
