    ...
    static class MediaBrowserImplBase implements MediaBrowserImpl, MediaBrowserServiceCallbackImpl {
        ...
        public MediaBrowserImplBase(Context context, ComponentName serviceComponent, ConnectionCallback callback, Bundle rootHints) {
            ...
            if (context == null) {
                ...
                this.mRootHints = rootHints != null ? new Bundle(rootHints) : bundle;
            }
        }
        ...
        public void subscribe(@NonNull String parentId, Bundle options, @NonNull SubscriptionCallback callback) {
            ...
            sub.putCallback(this.mContext, bundle, callback);
            if (isConnected()) {
                try {
    ...
    private static class CallbackHandler extends Handler {
        ...
        public void handleMessage(android.os.Message r9) {
            ...
            L_0x000e:
                ...
                int r4 = r9.what     // Catch:{ BadParcelableException -> 0x0087 }
                switch(r4) {
            ...
            L_0x0038:
                ...
                java.lang.StringBuilder r5 = new java.lang.StringBuilder     // Catch:{ BadParcelableException -> 0x0087 }
                r5.<init>()     // Catch:{ BadParcelableException -> 0x0087 }
                java.lang.String r6 = "Unhandled message: "
                java.lang.StringBuilder r5 = r5.append(r6)     // Catch:{ BadParcelableException -> 0x0087 }
                java.lang.StringBuilder r5 = r5.append(r9)     // Catch:{ BadParcelableException -> 0x0087 }
                java.lang.String r6 = "\n  Client version: "
                java.lang.StringBuilder r5 = r5.append(r6)     // Catch:{ BadParcelableException -> 0x0087 }
                r6 = 1
                java.lang.StringBuilder r5 = r5.append(r6)     // Catch:{ BadParcelableException -> 0x0087 }
                java.lang.String r6 = "\n  Service version: "
                java.lang.StringBuilder r5 = r5.append(r6)     // Catch:{ BadParcelableException -> 0x0087 }
                int r6 = r9.arg1     // Catch:{ BadParcelableException -> 0x0087 }
                java.lang.StringBuilder r5 = r5.append(r6)     // Catch:{ BadParcelableException -> 0x0087 }
                java.lang.String r5 = r5.toString()     // Catch:{ BadParcelableException -> 0x0087 }
                android.util.Log.w(r4, r5)     // Catch:{ BadParcelableException -> 0x0087 }
            L_0x006b:
                return
            L_0x006c:
                java.lang.String r4 = "data_media_item_id"
                java.lang.String r5 = r1.getString(r4)     // Catch:{ BadParcelableException -> 0x0087 }
                java.lang.String r4 = "data_media_session_token"
                android.os.Parcelable r4 = r1.getParcelable(r4)     // Catch:{ BadParcelableException -> 0x0087 }
                android.support.v4.media.session.MediaSessionCompat$Token r4 = (android.support.v4.media.session.MediaSessionCompat.Token) r4     // Catch:{ BadParcelableException -> 0x0087 }
                java.lang.String r6 = "data_root_hints"
                android.os.Bundle r6 = r1.getBundle(r6)     // Catch:{ BadParcelableException -> 0x0087 }
                r3.onServiceConnected(r0, r5, r4, r6)     // Catch:{ BadParcelableException -> 0x0087 }
                goto L_0x006b
            L_0x0087:
                r2 = move-exception
                java.lang.String r4 = "MediaBrowserCompat"
                ...
                goto L_0x006b
            L_0x0099:
                r3.onConnectionFailed(r0)     // Catch:{ BadParcelableException -> 0x0087 }
                goto L_0x006b
            L_0x009d:
                java.lang.String r4 = "data_media_item_id"
                java.lang.String r4 = r1.getString(r4)     // Catch:{ BadParcelableException -> 0x0087 }
                java.lang.String r5 = "data_media_item_list"
                java.util.ArrayList r5 = r1.getParcelableArrayList(r5)     // Catch:{ BadParcelableException -> 0x0087 }
                java.lang.String r6 = "data_options"
                android.os.Bundle r6 = r1.getBundle(r6)     // Catch:{ BadParcelableException -> 0x0087 }
                r3.onLoadChildren(r0, r4, r5, r6)     // Catch:{ BadParcelableException -> 0x0087 }
                goto L_0x006b
            */
