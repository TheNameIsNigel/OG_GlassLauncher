...
public class NotificationCompat {
    ...
    public static class MessagingStyle extends Style {
        ...
        public void apply(NotificationBuilderWithBuilderAccessor builder) {
            ...
            if (Build.VERSION.SDK_INT >= 16) {
                ...
                if (this.mConversationTitle == null) {
                    z = hasMessagesWithoutSender();
                } else {
                    z = true;
                }
                for (int i = this.mMessages.size() - 1; i >= 0; i--) {
                    Message message2 = this.mMessages.get(i);
                    CharSequence line = z ? makeMessageLine(message2) : message2.getText();
    ...
    public static class Action {
        ...
        public static final class Builder {
            ...
            private Builder(int icon, CharSequence title, PendingIntent intent, Bundle extras, RemoteInput[] remoteInputs, boolean allowGeneratedReplies) {
                ...
                this.mIntent = intent;
                this.mExtras = extras;
                this.mRemoteInputs = remoteInputs != null ? new ArrayList<>(Arrays.asList(remoteInputs)) : arrayList;
                this.mAllowGeneratedReplies = allowGeneratedReplies;
            }
    ...
    public static final class WearableExtender implements Extender {
        ...
        public WearableExtender(Notification notification) {
            ...
            if (bundle != null) {
                ArrayList<Parcelable> parcelables = bundle.getParcelableArrayList(KEY_ACTIONS);
    ...
    static Action getActionCompatFromAction(Notification.Action action) {
        ...
        if (srcArray == null) {
            ...
            RemoteInput[] remoteInputs = new RemoteInput[srcArray.length];
        ...
        } else if (!action.getExtras().getBoolean("android.support.allowGeneratedReplies")) {
