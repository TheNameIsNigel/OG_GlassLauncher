...
public class FrameMetricsAggregator {
    ...
    public FrameMetricsAggregator(int metricTypeFlags) {
        if (Build.VERSION.SDK_INT >= 24) {
            ...
            this.mInstance = new FrameMetricsBaseImpl((FrameMetricsBaseImpl) null);
        }
    }
    ...
    private static class FrameMetricsApi24Impl extends FrameMetricsBaseImpl {
        ...
        FrameMetricsApi24Impl(int trackingFlags) {
            super((FrameMetricsBaseImpl) null);
        ...
        public SparseIntArray[] remove(Activity activity) {
            Iterator activityRef$iterator = this.mActivities.iterator();
            while (true) {
                if (!activityRef$iterator.hasNext()) {
                    break;
                }
                WeakReference<Activity> activityRef = (WeakReference) activityRef$iterator.next();
