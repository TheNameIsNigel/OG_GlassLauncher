...
abstract class ModernAsyncTask<Params, Progress, Result> {
    ...
    /* renamed from: -android-support-v4-content-ModernAsyncTask$StatusSwitchesValues  reason: not valid java name */
    private static final /* synthetic */ int[] f1androidsupportv4contentModernAsyncTask$StatusSwitchesValues = null;
    ...
    /* renamed from: -getandroid-support-v4-content-ModernAsyncTask$StatusSwitchesValues  reason: not valid java name */
    private static /* synthetic */ int[] m64getandroidsupportv4contentModernAsyncTask$StatusSwitchesValues() {
        if (f1androidsupportv4contentModernAsyncTask$StatusSwitchesValues != null) {
            return f1androidsupportv4contentModernAsyncTask$StatusSwitchesValues;
        }
        ...
        f1androidsupportv4contentModernAsyncTask$StatusSwitchesValues = iArr;
        return iArr;
    }
    ...
    public final ModernAsyncTask<Params, Progress, Result> executeOnExecutor(Executor exec, Params... params) {
        if (this.mStatus != Status.PENDING) {
            switch (m64getandroidsupportv4contentModernAsyncTask$StatusSwitchesValues()[this.mStatus.ordinal()]) {
                case 1:
