...
public class TextInputLayout extends LinearLayout {
    ...
    public void updateLabelState(boolean animate, boolean force) {
        ...
        boolean z = this.mEditText != null ? !TextUtils.isEmpty(this.mEditText.getText()) : false;
        ...
        if (z || (isEnabled() && (isFocused || isErrorShowing))) {
    ...
    public void setError(@Nullable CharSequence error) {
        ...
        if (!ViewCompat.isLaidOut(this) || !isEnabled()) {
            ...
            z = this.mErrorView != null ? !TextUtils.equals(this.mErrorView.getText(), error) : true;
        }
        setError(error, z);
    }
    ...
    private boolean shouldShowPasswordIcon() {
        ...
        if (!hasPasswordTransformation()) {
            return this.mPasswordToggledVisible;
        }
        return true;
    }
