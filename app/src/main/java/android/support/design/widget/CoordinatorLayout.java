...
public class CoordinatorLayout extends ViewGroup implements NestedScrollingParent2 {
    ...
    private boolean performIntercept(MotionEvent ev, int type) {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            if ((intercepted || newBlock) && action != 0) {
                ...
                newBlock = isBlocking ? !wasBlocking : false;
    ...
    public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            if (child.getVisibility() != 8) {
                ...
                if (fitsSystemWindows && (!ViewCompat.getFitsSystemWindows(child))) {
                        ...
                        if (type != 0 || !checkLp.getChangedAfterNestedScroll()) {
                            switch (type) {
                                case 2:
                                    ...
                                    break;
                                default:
                                    z = b.onDependentViewChanged(this, checkChild, child);
                                    break;
                            }
                            if (type == 1) {
                                checkLp.setChangedAfterNestedScroll(z);
                            }
                        } else {
    ...
    public void offsetChildToAnchor(View child, int layoutDirection) {
        ...
        if (lp.mAnchorView != null) {
            ...
            if (desiredChildRect.left == childRect.left) {
                changed = desiredChildRect.top != childRect.top;
            } else {
                changed = true;
            }
    ...
    public static class LayoutParams extends ViewGroup.MarginLayoutParams {
        ...
        public boolean dependsOn(CoordinatorLayout parent, View child, View dependency) {
            ...
            if (this.mBehavior != null) {
                return this.mBehavior.layoutDependsOn(parent, child, dependency);
            }
            return false;
        }
        ...
        private boolean shouldDodge(View other, int layoutDirection) {
            ...
            if (absInset == 0 || (GravityCompat.getAbsoluteGravity(this.dodgeInsetEdges, layoutDirection) & absInset) != absInset) {
                return false;
            }
            return true;
        }
