...
public class AppBarLayout extends LinearLayout {
    ...
    public static class Behavior extends HeaderBehavior<AppBarLayout> {
        ...
        public boolean onStartNestedScroll(CoordinatorLayout parent, AppBarLayout child, View directTargetChild, View target, int nestedScrollAxes, int type) {
            boolean started;
            if ((nestedScrollAxes & 2) == 0 || !child.hasScrollableChildren()) {
                started = false;
            } else {
                started = parent.getHeight() - directTargetChild.getHeight() <= child.getHeight();
            }
        ...
        private int interpolateOffset(AppBarLayout layout, int offset) {
            ...
            while (true) {
                ...
                if (absOffset < child.getTop() || absOffset > child.getBottom()) {
                    ...
                    if ((flags & 1) != 0) {
                        childScrollableHeight = child.getHeight() + childLp.topMargin + childLp.bottomMargin + 0;
                        if ((flags & 2) != 0) {
        ...
        protected static class SavedState extends AbsSavedState {
            ...
            public SavedState(Parcel source, ClassLoader loader) {
                ...
                this.firstVisibleChildAtMinimumHeight = source.readByte() != 0 ? true : z;
            }
