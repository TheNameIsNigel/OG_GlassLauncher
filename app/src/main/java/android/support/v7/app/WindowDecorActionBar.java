...
public class WindowDecorActionBar extends ActionBar implements ActionBarOverlayLayout.ActionBarVisibilityCallback {
    ...
    static final /* synthetic */ boolean f2assertionsDisabled = (!WindowDecorActionBar.class.desiredAssertionStatus());
    ...
    public WindowDecorActionBar(View layout) {
        if (f2assertionsDisabled || layout.isInEditMode()) {
            init(layout);
            return;
        }
