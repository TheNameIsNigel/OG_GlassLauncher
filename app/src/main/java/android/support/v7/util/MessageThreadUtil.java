...
class MessageThreadUtil<T> implements ThreadUtil<T> {
    ...
    public ThreadUtil.MainThreadCallback<T> getMainThreadProxy(final ThreadUtil.MainThreadCallback<T> callback) {
        return new ThreadUtil.MainThreadCallback<T>() {
            ...
            {
                final ThreadUtil.MainThreadCallback mainThreadCallback = callback;
                this.mMainThreadRunnable = new Runnable() {
                    public void run() {
                        ...
                        while (msg != null) {
                            switch (msg.what) {
                                case 1:
                                    mainThreadCallback.updateItemCount(msg.arg1, msg.arg2);
                                    break;
                                case 2:
                                    mainThreadCallback.addTile(msg.arg1, (TileList.Tile) msg.data);
                                    break;
                                case 3:
                                    mainThreadCallback.removeTile(msg.arg1, msg.arg2);
                                    break;
                                default:
    ...
    public ThreadUtil.BackgroundCallback<T> getBackgroundProxy(final ThreadUtil.BackgroundCallback<T> callback) {
        return new ThreadUtil.BackgroundCallback<T>() {
            ...
            {
                final ThreadUtil.BackgroundCallback backgroundCallback = callback;
                            ...
                            if (msg != null) {
                                switch (msg.what) {
                                    case 1:
                                        ...
                                        backgroundCallback.refresh(msg.arg1);
                                        break;
                                    case 2:
                                        AnonymousClass2.this.mQueue.removeMessages(2);
                                        AnonymousClass2.this.mQueue.removeMessages(3);
                                        backgroundCallback.updateRange(msg.arg1, msg.arg2, msg.arg3, msg.arg4, msg.arg5);
                                        break;
                                    case 3:
                                        backgroundCallback.loadTile(msg.arg1, msg.arg2);
                                        break;
                                    case 4:
                                        backgroundCallback.recycleTile((TileList.Tile) msg.data);
                                        break;
                                    default:
                                        Log.e("ThreadUtil", "Unsupported message, what=" + msg.what);
                                        break;
