...
class FastScroller extends RecyclerView.ItemDecoration implements RecyclerView.OnItemTouchListener {
    ...
    FastScroller(RecyclerView recyclerView, StateListDrawable verticalThumbDrawable, Drawable verticalTrackDrawable, StateListDrawable horizontalThumbDrawable, Drawable horizontalTrackDrawable, int defaultWidth, int scrollbarMinimumRange, int margin) {
        ...
        this.mShowHideAnimator.addListener(new AnimatorListener(this, (AnimatorListener) null));
        this.mShowHideAnimator.addUpdateListener(new AnimatorUpdater(this, (AnimatorUpdater) null));
    ...
    public void updateScrollPosition(int offsetX, int offsetY) {
        ...
        this.mNeedVerticalScrollbar = verticalContentLength - verticalVisibleLength > 0 ? this.mRecyclerViewHeight >= this.mScrollbarMinimumRange : false;
        ...
        this.mNeedHorizontalScrollbar = horizontalContentLength - horizontalVisibleLength > 0 ? this.mRecyclerViewWidth >= this.mScrollbarMinimumRange : false;
    ...
    public boolean isPointInsideHorizontalThumb(float x, float y) {
        if (y < ((float) (this.mRecyclerViewHeight - this.mHorizontalThumbHeight)) || x < ((float) (this.mHorizontalThumbCenterX - (this.mHorizontalThumbWidth / 2))) || x > ((float) (this.mHorizontalThumbCenterX + (this.mHorizontalThumbWidth / 2)))) {
            return false;
        }
        return true;
    }
    ...
    private class AnimatorListener extends AnimatorListenerAdapter {
        ...
        /* synthetic */ AnimatorListener(FastScroller this$02, AnimatorListener animatorListener) {
            this();
        }
    ...
    private class AnimatorUpdater implements ValueAnimator.AnimatorUpdateListener {
        /* synthetic */ AnimatorUpdater(FastScroller this$02, AnimatorUpdater animatorUpdater) {
            this();
        }
