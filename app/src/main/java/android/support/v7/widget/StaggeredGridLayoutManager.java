...
public class StaggeredGridLayoutManager extends RecyclerView.LayoutManager implements RecyclerView.SmoothScroller.ScrollVectorProvider {
    ...
    private void onLayoutChildren(RecyclerView.Recycler recycler, RecyclerView.State state, boolean shouldCheckForGaps) {
        ...
        if (!anchorInfo.mValid || this.mPendingScrollPosition != -1) {
            ...
            recalculateAnchor = this.mPendingSavedState != null;
        }
        ...
        if (shouldCheckForGaps && (!state.isPreLayout())) {
            if (this.mGapStrategy == 0 || getChildCount() <= 0) {
                ...
                needToCheckForGaps = this.mLaidOutInvalidFullSpan || hasGapsToFix() != null;
            }
    ...
    private void updateLayoutState(int anchorPosition, RecyclerView.State state) {
        ...
        if (this.mPrimaryOrientation.getMode() != 0) {
            z2 = false;
        } else if (this.mPrimaryOrientation.getEnd() != 0) {
            z2 = false;
        }
