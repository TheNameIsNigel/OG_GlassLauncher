...
public abstract class ForwardingListener implements View.OnTouchListener, View.OnAttachStateChangeListener {
    ...
    public boolean onTouch(View v, MotionEvent event) {
        ...
        if (wasForwarding) {
            onForwardingStarted = !onTouchForwarded(event) ? !onForwardingStopped() : true;
        } else {
            onForwardingStarted = onTouchObserved(event) ? onForwardingStarted() : false;
        ...
        this.mForwarding = onForwardingStarted;
        if (!onForwardingStarted) {
