    ...
    public void createAnimators(ViewGroup sceneRoot, TransitionValuesMaps startValues, TransitionValuesMaps endValues, ArrayList<TransitionValues> startValuesList, ArrayList<TransitionValues> endValuesList) {
        ...
        for (int i = 0; i < startValuesListCount; i++) {
            ...
            if (start != null || end != null) {
                if (((start == null || end == null) ? true : isTransitionRequired(start, end)) && (animator = createAnimator(sceneRoot, start, end)) != null) {
            ...
            if (!(anim == null || (oldInfo = runningAnimators.get(anim)) == null || oldInfo.mView == null)) {
                if (windowId.equals(oldInfo.mWindowId)) {
                    ...
                    if (startValues == null && endValues == null) {
                        ...
                        z = oldInfo.mTransition.isTransitionRequired(oldValues, endValues);
                    }
                    if (z) {
