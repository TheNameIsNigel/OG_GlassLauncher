...
public class ChangeTransform extends Transition {
    ...
    public Animator createAnimator(@NonNull ViewGroup sceneRoot, TransitionValues startValues, TransitionValues endValues) {
        ...
        boolean z = this.mReparent ? !parentsMatch(startParent, (ViewGroup) endValues.values.get(PROPNAME_PARENT)) : false;
        ...
        ObjectAnimator transformAnimator = createTransformAnimator(startValues, endValues, z);
        if (z && transformAnimator != null && this.mUseOverlay) {
    ...
    private boolean parentsMatch(ViewGroup startParent, ViewGroup endParent) {
        ...
        return endValues != null && endParent == endValues.view;
    }
    ...
    private static class Transforms {
        ...
        public int hashCode() {
            ...
            int i6;
            int i7 = 0;
            int floatToIntBits = (this.mTranslationX != 0.0f ? Float.floatToIntBits(this.mTranslationX) : 0) * 31;
